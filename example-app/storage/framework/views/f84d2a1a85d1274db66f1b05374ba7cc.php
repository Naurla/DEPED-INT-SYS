...
<body class="bg-gray-100 flex h-screen overflow-hidden" x-data="{ sidebarOpen: true, uploadModal: false }">
    ...
    >
        ...
        <nav class="flex-grow p-4 space-y-2 text-sm overflow-y-auto">
           ...
           <a href="<?php echo e(route('admin.advisory.index')); ?>" class="flex items-center space-x-3 px-4 py-3 hover:bg-red-700 rounded-lg transition-colors">
        ...
        <main class="flex-grow p-8 overflow-y-auto bg-gray-50">
            ...
            <div class="mb-8">
                ...
                <div class="max-w-md bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden group">
                    <a href="<?php echo e(asset('assets/pdfs/advisory_financial_donations.pdf')); ?>" target="_blank" class="block relative">
                        <img src="<?php echo e(asset('public/images/banner.png')); ?>" alt="Public Advisory" class="w-full h-auto">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 font-semibold text-gray-700">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="<?php echo e(asset('assets/pdfs/advisory_financial_donations.pdf')); ?>" target="_blank" class="hover:text-red-700 hover:underline">
...
</html><?php /**PATH C:\Users\Noltan\Desktop\DEPED INT SYS\example-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>