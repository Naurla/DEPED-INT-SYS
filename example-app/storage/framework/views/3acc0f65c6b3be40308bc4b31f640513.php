...
<body class="bg-gray-100 font-['Inter'] flex flex-col min-h-screen" 
    x-data="{ 
        ...
        activeSlide: 1, 
        slides: [
            '<?php echo e(asset('images/banner1.png')); ?>',
            '<?php echo e(asset('images/foi.png')); ?>',
            '<?php echo e(asset('images/rnp.png')); ?>'
        ] 
    }" 
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex flex-col md:flex-row items-center gap-4 md:gap-6 text-center md:text-left">
                ...
                <div class="flex items-center gap-4">
                    <img src="<?php echo e(asset('images/deped.png')); ?>" 
                         alt="DepEd Logo" 
                         class="h-16 md:h-20 w-auto drop-shadow-md">
                    
                    <img src="<?php echo e(asset('images/r9.png')); ?>" 
                         alt="Region IX Logo" 
                         class="h-16 md:h-20 w-auto drop-shadow-md">
                </div>
    ...
    <h1 class="text-2xl md:text-[25px] uppercase tracking-wide pt-1 font-black">Zamboanga City Division</h1>
            ...
            <div class="flex items-center">
                <img src="<?php echo e(asset('images/ts.png')); ?>" 
    ...
    <main class="flex-grow">
        ...
        <section class="container mx-auto mt-4 text-left">
            ...
            <div class="p-10 bg-white shadow-sm mb-10">
                <?php if(isset($advisories) && count($advisories) > 0): ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <?php $__currentLoopData = $advisories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advisory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="group bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                                <a href="<?php echo e(asset('storage/' . $advisory->pdf_path)); ?>" target="_blank" class="block relative overflow-hidden">
                                    <img src="<?php echo e(asset('storage/' . $advisory->image_path)); ?>" 
                                         alt="<?php echo e($advisory->title); ?>" 
                                ...
                                <div class="p-5">
                                    ...
                                    <h3 class="font-bold text-gray-800 text-lg leading-tight mb-2">
                                        <?php echo e($advisory->title); ?>

                                    </h3>
                                    <p class="text-gray-500 text-xs italic">
                                        Posted on <?php echo e($advisory->created_at->format('M d, Y')); ?>
    ...
    >
        <div class="bg-white w-full max-w-md rounded-lg shadow-2xl overflow-hidden" @click.away="loginModal = false">
            ...
            <form action="<?php echo e(route('admin.login')); ?>" method="POST" class="p-8">
                <?php echo csrf_field(); ?>
                <div class="mb-5">
    ...
    <footer class="bg-[#f2f2f2] text-gray-700 py-12 border-t border-gray-300">
        <div class="container mx-auto px-6 lg:px-20 flex flex-wrap md:flex-nowrap items-start gap-8">
            <div class="w-full md:w-1/6 flex justify-center md:justify-start">
                <img src="<?php echo e(asset('images/rnp.png')); ?>" alt="PH Seal" class="w-[150px] h-auto object-contain">
            </div>
            ...
            <div class="w-full md:w-1/6 flex justify-center md:justify-end">
                <img src="<?php echo e(asset('images/foi.png')); ?>" alt="FOI Logo" class="w-[150px] h-auto object-contain">
            </div>
        </div>
    </footer>
</body>
</html><?php /**PATH C:\Users\Noltan\Desktop\DEPED INT SYS\example-app\resources\views/index.blade.php ENDPATH**/ ?>