...
class JuniorHighFrontendController extends Controller
{
    public function index(Request $request)
    {
        ...
        $allContents = JuniorHighContent::latest()->get()->map(function($item) use ($tab, $districtFilter, $search) {
            // Passing 'JHS' as the level keyword
            return $this->parseSpreadsheetData($item, 'JHS', $tab, $districtFilter, $search);
        });
        ...
        return view('frontend.junior_high.index', compact('contents', 'tab', 'districts', 'districtFilter', 'search'));
    }
