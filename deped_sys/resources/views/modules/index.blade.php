            ...
            @forelse($items as $item)
                <div class="group transition-all duration-300">
                    ...
                    <div class="flex items-center gap-6">
                        <a href="{{ route('k12.als.modules.show', $item->id) }}"class="inline-block border border-gray-400 text-gray-500 px-6 py-2 text-xs font-black uppercase tracking-widest hover:bg-gray-50 hover:text-gray-700 transition-colors">
                            Read More
                        </a>
