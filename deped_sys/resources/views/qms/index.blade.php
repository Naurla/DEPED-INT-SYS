...
<div class="bg-gray-100 py-3 border-b border-gray-200">
    <div class="container mx-auto px-6 lg:px-20 text-sm text-gray-600">
        ...
        <span class="font-semibold text-gray-800">QMS Scope, Quality Policy, Quality Objective</span>
    </div>
</div>

<div class="container mx-auto px-6 lg:px-20 py-10" x-data="{ activeTab: 'scope' }">
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="w-full md:w-[30%] lg:w-[25%] flex-shrink-0">
            <div class="flex flex-col border border-gray-200 bg-[#f8f9fa] shadow-sm">
                ...
                <button @click="activeTab = 'scope'" 
                        :class="activeTab === 'scope' ? 'bg-[#a52a2a] text-white' : 'text-gray-700 hover:bg-gray-200 bg-transparent'"
                ...
                <button @click="activeTab = 'policy'" 
                        :class="activeTab === 'policy' ? 'bg-[#a52a2a] text-white' : 'text-gray-700 hover:bg-gray-200 bg-transparent'"
                        class="text-left font-bold py-4 px-5 border-b border-gray-200 transition-all duration-200 focus:outline-none uppercase tracking-wide text-[13px]">
                    QUALITY POLICY
                </button>
                
                <button @click="activeTab = 'objective'" 
                        :class="activeTab === 'objective' ? 'bg-[#a52a2a] text-white' : 'text-gray-700 hover:bg-gray-200 bg-transparent'"
        ...
        <div class="w-full md:w-[70%] lg:w-[75%] md:border-l md:border-gray-200 md:pl-8">
            ...
            <div class="bg-transparent min-h-[300px]">
                ...
                <div x-show="activeTab === 'scope'" x-cloak x-transition.opacity.duration.300ms>
                    <h3 class="text-[22px] font-bold text-gray-800 mb-2">QMS Scope</h3>
                ...
                <div x-show="activeTab === 'policy'" x-cloak x-transition.opacity.duration.300ms>
                    <h3 class="text-[22px] font-bold text-gray-800 mb-2">Quality Policy</h3>
                    <div class="w-12 h-1 bg-[#a52a2a] mb-6"></div> 
                    <div class="qms-content text-gray-700 text-[15px] leading-relaxed">
                ...
                <div x-show="activeTab === 'objective'" x-cloak x-transition.opacity.duration.300ms>
                    <h3 class="text-[22px] font-bold text-gray-800 mb-2">Quality Objective</h3>
                    <div class="w-12 h-1 bg-[#a52a2a] mb-6"></div> 
                    <div class="qms-content text-gray-700 text-[15px] leading-relaxed">
...
@push('styles')
<style>
    /* Styling for the Rich Text Editor output so it renders properly in Tailwind */
    ...
    .qms-content strong, .qms-content b {
        font-weight: 700;
        color: #111827;
    }
    .qms-content a {
