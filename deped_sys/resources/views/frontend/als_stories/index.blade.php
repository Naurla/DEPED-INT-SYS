        ...
        <div class="space-y-16">
            @forelse($items as $item)
                <div class="group transition-all duration-300">
                    ...
                    <a href="{{ route('als-stories.show', ['id' => $item->id]) }}" class="block">
                    ...
                    <div class="flex items-center gap-6">
                        <a href="{{ route('als-stories.show', ['id' => $item->id]) }}" class="inline-block border border-gray-300 text-gray-600 px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-gray-50 hover:text-gray-900 transition-colors rounded-sm shadow-sm">
                            Read More
                        </a>
