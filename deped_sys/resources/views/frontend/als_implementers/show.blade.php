...
<div class="bg-white py-10 min-h-screen">
    <div class="container mx-auto px-6 lg:px-20 max-w-6xl">
        ...
        {{-- Header Section --}}
        <div class="mb-8">
            <a href="{{ route('als-implementers.index') }}" class="text-[#a52a2a] hover:text-red-800 font-bold text-sm inline-flex items-center mb-6 uppercase tracking-wider">
        ...
        <p class="text-gray-400 text-xs text-center mb-16 font-medium">This is published by DepEd Zamboanga City.</p>
