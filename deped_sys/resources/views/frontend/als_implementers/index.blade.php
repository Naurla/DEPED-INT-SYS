        ...
        <div class="space-y-16">
            @forelse($items as $item)
                <div class="group transition-all duration-300">
                    ...
                    <div>
                        <a href="{{ route('als-implementers.show', ['id' => $item->id]) }}" class="inline-block border border-gray-400 text-gray-500 px-6 py-2 text-xs font-black uppercase tracking-widest hover:bg-gray-50 hover:text-gray-700 transition-colors">
                            Read More
                        </a>
                    </div>
                </div>
