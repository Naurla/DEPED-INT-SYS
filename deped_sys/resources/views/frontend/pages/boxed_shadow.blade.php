...
<div class="container mx-auto px-4 md:px-20 max-w-10xl py-8 md:py-12">
    
    <div class="bg-white rounded-xl shadow-2xl p-6 md:p-10 border-t-8 border-[#a52a2a]">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center uppercase tracking-wide">{{ $page->title }}</h1>
