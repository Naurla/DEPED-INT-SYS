...
<div x-data="{ 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center">
            <h3 class="font-bold text-gray-800 text-xl">Public Advisories</h3>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 font-semibold text-gray-700">{{ $advisory->title }}</td>
                        ...
                        <td class="px-6 py-4 text-center space-x-3">
                            ...
                            <button @click="confirmDelete({{ $advisory->id }})" class="text-red-600 font-bold uppercase text-xs hover:underline">Delete</button>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="3" class="px-6 py-10 text-center text-gray-400">No advisories found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden z-50 w-full max-w-md">
                ...
                <form :action="editMode ? '/admin/advisories/' + advisoryId : '{{ route('admin.advisories.store') ?? '#' }}'" 
                    ...
                    <div class="pt-4 flex justify-end space-x-3">
                        ...
                        <button type="submit" class="px-6 py-2 text-sm font-bold bg-[#a52a2a] text-white rounded-lg hover:bg-red-800" x-text="editMode ? 'Save Changes' : 'Upload'"></button>
                    </div>
                </form>
            </div>
        </div>
