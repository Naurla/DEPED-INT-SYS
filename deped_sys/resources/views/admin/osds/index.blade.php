...
<div x-data="{ 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center">
            <h3 class="font-bold text-gray-800 text-xl">Office of the Schools Division Superintendent</h3>
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden z-50 w-full max-w-lg">
                ...
                <form :action="editMode ? '/admin/osds/' + itemId : '{{ route('admin.osds.store') }}'" 
                    ...
                    <div>
                        ...
                        <input type="text" name="title" x-model="formData.title" placeholder="e.g., OSDS Organizational Chart 2024" required class="w-full border rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-red-500">
                    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 text-center">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-2xl z-[70] w-full max-w-sm">
                ...
                <div class="flex space-x-3">
                    ...
                    <form :action="'/admin/osds/' + itemId" method="POST" class="flex-1">
                        @csrf @method('DELETE')
