...
<div class="w-full mx-auto">
    <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
        ...
        <div class="bg-gray-50 border-b border-gray-200 py-4 px-6">
            <h6 class="m-0 font-bold text-[#a52a2a] uppercase tracking-wide">Manage DepEd Data Privacy</h6>
        </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('admin.data_privacy.update') }}" method="POST">
                ...
                <div class="mb-8">
                    <label for="notice" class="block text-gray-800 text-sm font-bold mb-2 uppercase tracking-wide">Data Privacy Notice</label>
                    <textarea class="w-full border border-gray-300 px-4 py-3 rounded-md focus:ring-2 focus:ring-[#a52a2a] focus:border-[#a52a2a] outline-none transition-shadow editor" 
                              id="notice" name="notice" rows="10">{{ old('notice', $data->notice ?? '') }}</textarea>
                </div>
