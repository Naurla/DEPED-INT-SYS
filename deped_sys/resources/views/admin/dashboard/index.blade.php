...
<div class="w-full px-4 sm:px-6 lg:px-8 pb-10 font-sans overflow-x-hidden">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-10">
        ...
        @php
            $cards = [
                ['route' => 'admin.issuances.index', 'color' => 'emerald', 'count' => $counts['issuances'] ?? 0, 'label' => 'Issuances', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>'],
