            ...
            <form :action="editMode ? editUrl : '{{ route('admin.curriculum.elementary.store') }}'" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <input type="text" name="title" x-model="formData.title" placeholder="e.g. Master Elementary Curriculum" required class="w-full border border-gray-300 p-2.5 text-sm rounded-lg focus:ring-2 focus:ring-red-500 outline-none">
                    </div>
