...
<div x-data="{ 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/80">
            ...
            <button @click="bannerModal = true" class="bg-[#a52a2a] text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-[#a52a2a] shadow-md transition-all active:scale-95">
                + Add New Banner
            </button>
        </div>
